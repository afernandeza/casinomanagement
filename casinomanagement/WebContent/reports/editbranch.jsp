...
<title>RGMS - Reports</title>
    ...
    <SCRIPT LANGUAGE="JavaScript">
		function change_country(country){
			window.location = "editbranch.jsp?country="+country;
		}
		function change_state(state){
			window.location = "editbranch.jsp?country="+document.forma_edicion.country.options[document.forma_edicion.country.selectedIndex].value+"&state="+state;
		}
		function change_town(town){
			window.location = "editbranch.jsp?country="+document.forma_edicion.country.options[document.forma_edicion.country.selectedIndex].value+"&state="+document.forma_edicion.state.options[document.forma_edicion.state.selectedIndex].value+"&town="+town;
		}
    </SCRIPT>
		...
		<div id="content">
			<div class="post">
				...
				<div class="entry">
					...
					<br><br>
					<form name="forma_edicion" action="edit1.jsp" method="post">
					<table border="0">
					  <tr>
					    <td>Pa&iacute;s:</td>
					...
					<form name="byName" action="editByName.jsp" method="post">
