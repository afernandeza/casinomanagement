		...
		<div id="content">
			<div class="post">
				<div class="entry">
				    ...
				    <FORM NAME="opciones" action="repSesiones.jsp" method="post">
				      <p>Elegir Sucursal: 
				      ...
				      <A HREF="#" onClick="cal.select(document.forms['opciones'].date1,'anchor1','yyyy-MM-dd'); return false;" NAME="anchor1" ID="anchor1"><img src="calendar.png" border="0" height="30" weight="30"></A>
				      </p>
				
				      <p> Fecha de t&eacute;rmino para el reporte: 
				      <INPUT TYPE="text" NAME="date2" VALUE="" SIZE=25 readonly="readonly"></INPUT>
				      <A HREF="#" onClick="cal.select(document.forms['opciones'].date2,'anchor2','yyyy-MM-dd'); return false;" NAME="anchor1" ID="anchor2"><img src="calendar.png" border="0" height="30" weight="30"></A>
